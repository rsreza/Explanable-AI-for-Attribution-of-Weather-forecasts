...
## Multi-Method Explainable AI for AI based Weather Prediction Model
...
#### 4. Understanding the Input Data Format
...
- Sharing the sample input data for testing and evaluation
- Providing the ONNX model files that enable inference and analysis
